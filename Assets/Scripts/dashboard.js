...
function toggleForm(type) {
  ...
  if (type === 'rule') {
    const isVisible = ruleForm.classList.contains('show');
    ruleForm.classList.toggle('show', !isVisible);
    packetForm.classList.remove('show');
  } else if (type === 'packet') {
    const isVisible = packetForm.classList.contains('show');
    packetForm.classList.toggle('show', !isVisible);
    ruleForm.classList.remove('show');
  }
}


// By default show Add Rule on mobile
